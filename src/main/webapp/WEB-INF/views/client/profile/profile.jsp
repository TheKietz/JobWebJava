                    ...
                    <form>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" disabled value="${profile.fullName}">
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" disabled value="${profile.phone}">
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    <label>Tạo lúc</label>
                                    <input type="text" class="form-control" disabled value="${profile.createdAt}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                <div class="form-group">
                                    <label>Kĩ năng</label>
                                    <input type="text" class="form-control" disabled value="${profile.skills}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mt-3">
                            <div class="update ml-auto mr-auto text-center">
                                <button type="button" class="btn btn-light-blue btn-round px-4 py-2">Chỉnh Sửa Thông Tin</button>
                            </div>
                        </div>
                    </form>
                </div>

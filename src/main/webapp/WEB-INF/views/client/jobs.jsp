                                ...
                                <div class="single-job-items mb-30">
                                    <div class="job-items">
                                        ...
                                        <div class="job-tittle job-tittle2">
                                            <a href="${pageContext.request.contextPath}/jobs/detail/${job.jobID}">
                                                <h4>${job.title}</h4>
                                            </a>
                                            <ul>
                                    ...
                                    <div class="items-link items-link2 f-right">
                                        <a href="${pageContext.request.contextPath}/jobs/detail/${job.jobID}">${job.jobType}</a>
                                        <span>
                                            <fmt:formatDate value="${job.postedAt}" pattern="dd/MM/yyyy" />
                                        </span>
                                    </div>
                                </div>
                            </c:forEach>

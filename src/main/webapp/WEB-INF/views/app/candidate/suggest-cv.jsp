                                ...
                                <c:otherwise>
                                    <c:forEach var="candidate" items="${candidates}" varStatus="loop">
                                        <tr>
                                            ...
                                            <td>                                                
                                                <a href="${pageContext.request.contextPath}/app/suggest-cv/add/${candidate.id}" class="btn btn-sm btn-success" onclick="return confirm('Bạn muốn mmời phỏng vấn ${candidate.fullName}?')">Phỏng vấn</a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                </c:otherwise>

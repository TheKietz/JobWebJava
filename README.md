...
![SQL Server](https://img.shields.io/badge/SQL_Server-2022-red?logo=sqlserver&logoColor=white)
...
- **Admin CMS & Thống kê thông minh:** 
  - Quản lý toàn diện hệ sinh thái: Người dùng, Gói dịch vụ (Service Packages), Tin tuyển dụng và Giao dịch tài chính (Transactions).
- **Cổng Nhà tuyển dụng (Employer Portal):**
  - Quản lý hồ sơ doanh nghiệp và đăng tải tin tuyển dụng (Job Postings).
- **Client cho candidates):**
  - Đăng ký các Job do Employer đăng tuyển
  
## Nền tảng Công nghệ
- **Back-end:** Java, Spring Framework (Spring MVC).
- **Cơ sở dữ liệu:** SQLServer 2022
